...
type FieldType = 'text' | 'email' | 'tel' | 'url' | 'password' | 'number' | 'textarea' | 'select' | 'boolean' | 'checkbox' | 'tags' | 'image' | 'file' | 'color' | 'date' | 'time' | 'datetime';
    ...
    <div class="form-group mb-4">
        ...
        <template v-else-if="type === 'textarea'">
            <textarea
                ...
                :rows="rows"
                class="form-control"
                :class="{ 'is-invalid': error, 'font-monospace': monospace }"
            ></textarea>
        </template>
